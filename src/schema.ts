...
import { GraphQLSchema, GraphQLObjectType, GraphQLList, GraphQLInt, printSchema, GraphQLNonNull } from 'graphql';
...
const schemaInitiator = (wizPersonalToken: string, wizCompanyKey: string, wizUrl: string): GraphQLSchema => {
...
export { schema, createSDL, schemaInitiator };
