...
const PostTransactionsResponseType = new GraphQLUnionType({
  ...
  types: [PostTransactionsResponseWithoutErrors, PostTransactionsResponseWithErrors],
  description: 'Response for Posting Transactions to a Batch',
  resolveType: (data) => {
...
export { RecordType, TransactionType, PostTransactionsResponseType, postTransactionsToBatchArgs };
