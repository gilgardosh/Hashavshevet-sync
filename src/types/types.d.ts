...
export type Company = {
    __typename?: 'Company';
    companyFileName: Scalars['String'];
    companyName: Scalars['String'];
    compVatnum: Scalars['String'];
};
...
export type ResolversTypes = {
    ...
    IsuueBatch:
        ...
        | ResolversTypes['BatchCheckMessage']
        | ResolversTypes['BatchCheckList'];
    IssueBatchStatus: ResolverTypeWrapper<IssueBatchStatus>;
    PostTransactionsResponse:
        | ResolversTypes['PostTransactionsResponsWithoutErrors']
        | ResolversTypes['PostTransactionsResponsWithErrors'];
...
export type ResolversParentTypes = {
    ...
    IsuueBatch:
        ...
        | ResolversParentTypes['BatchCheckMessage']
        | ResolversParentTypes['BatchCheckList'];
    IssueBatchStatus: IssueBatchStatus;
    PostTransactionsResponse:
        | ResolversParentTypes['PostTransactionsResponsWithoutErrors']
        | ResolversParentTypes['PostTransactionsResponsWithErrors'];
...
> = {
    getRecordById?: Resolver<
        Maybe<ResolversTypes['Record']>,
        ParentType,
        ContextType,
        RequireFields<QueryGetRecordByIdArgs, 'id'>
    >;
    ...
    getBatchById?: Resolver<
        Maybe<ResolversTypes['Batch']>,
        ParentType,
        ContextType,
        RequireFields<QueryGetBatchByIdArgs, 'id'>
    >;
    getBatches?: Resolver<Maybe<Array<Maybe<ResolversTypes['Batch']>>>, ParentType, ContextType>;
    getAccountById?: Resolver<
        Maybe<ResolversTypes['Account']>,
        ParentType,
        ContextType,
        RequireFields<QueryGetAccountByIdArgs, 'id'>
    >;
    getAccounts?: Resolver<Maybe<Array<Maybe<ResolversTypes['Account']>>>, ParentType, ContextType>;
    getBankPageRecordById?: Resolver<
        Maybe<ResolversTypes['BankPageRecord']>,
        ParentType,
        ContextType,
        RequireFields<QueryGetBankPageRecordByIdArgs, 'id'>
    >;
    getBankPageRecords?: Resolver<Maybe<Array<Maybe<ResolversTypes['BankPageRecord']>>>, ParentType, ContextType>;
    getBankPageById?: Resolver<
        Maybe<ResolversTypes['BankPage']>,
        ParentType,
        ContextType,
        RequireFields<QueryGetBankPageByIdArgs, 'id'>
    >;
    ...
    checkBatch?: Resolver<
        Maybe<ResolversTypes['BatchErrorReport']>,
        ParentType,
        ContextType,
        RequireFields<QueryCheckBatchArgs, 'id'>
    >;
};
...
> = {
    ...
    foreignCurrencyCumulativeBalanceWithoutOpeningBalance?: Resolver<
...
export type BankPageRecordResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['BankPageRecord'] = ResolversParentTypes['BankPageRecord']
> = {
    account?: Resolver<Maybe<ResolversTypes['Account']>, ParentType, ContextType>;
...
export type BankPageResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['BankPage'] = ResolversParentTypes['BankPage']
> = {
    id?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
export type HashavshevetUserResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['HashavshevetUser'] = ResolversParentTypes['HashavshevetUser']
> = {
...
export type BatchErrorReportResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['BatchErrorReport'] = ResolversParentTypes['BatchErrorReport']
> = {
    __resolveType: TypeResolveFn<'BatchCheckMessage' | 'BatchCheckList', ParentType, ContextType>;
};

export type BatchCheckMessageResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['BatchCheckMessage'] = ResolversParentTypes['BatchCheckMessage']
> = {
    batch_check?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    __isTypeOf?: isTypeOfResolverFn<ParentType>;
};

export type BatchCheckListResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['BatchCheckList'] = ResolversParentTypes['BatchCheckList']
> = {
    batch_check?: Resolver<Maybe<Array<Maybe<ResolversTypes['ARecordErrorDetails']>>>, ParentType, ContextType>;
    __isTypeOf?: isTypeOfResolverFn<ParentType>;
};

export type ARecordErrorDetailsResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['ARecordErrorDetails'] = ResolversParentTypes['ARecordErrorDetails']
> = {
...
> = {
    ...
    issueBatch?: Resolver<
        Maybe<ResolversTypes['IsuueBatch']>,
        ParentType,
        ContextType,
        RequireFields<MutationIssueBatchArgs, 'id'>
    >;
    postTransactionsToBatch?: Resolver<
        Maybe<ResolversTypes['PostTransactionsResponse']>,
        ParentType,
        ContextType,
        RequireFields<MutationPostTransactionsToBatchArgs, never>
    >;
    postBankPage?: Resolver<
        Maybe<ResolversTypes['PostBankPageResponse']>,
        ParentType,
        ContextType,
        RequireFields<MutationPostBankPageArgs, 'bankPageRecords'>
    >;
};

export type NewBatchResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['NewBatch'] = ResolversParentTypes['NewBatch']
> = {
...
export type IsuueBatchResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['IsuueBatch'] = ResolversParentTypes['IsuueBatch']
> = {
    __resolveType: TypeResolveFn<'IssueBatchStatus' | 'BatchCheckMessage' | 'BatchCheckList', ParentType, ContextType>;
};

export type IssueBatchStatusResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['IssueBatchStatus'] = ResolversParentTypes['IssueBatchStatus']
> = {
    batch_issue?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    __isTypeOf?: isTypeOfResolverFn<ParentType>;
};

export type PostTransactionsResponseResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['PostTransactionsResponse'] = ResolversParentTypes['PostTransactionsResponse']
> = {
    __resolveType: TypeResolveFn<
        'PostTransactionsResponsWithoutErrors' | 'PostTransactionsResponsWithErrors',
        ParentType,
        ContextType
    >;
};

export type PostTransactionsResponsWithoutErrorsResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['PostTransactionsResponsWithoutErrors'] = ResolversParentTypes['PostTransactionsResponsWithoutErrors']
> = {
    status?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    batch_issue?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    batch_check?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PostTransactionsResponsWithErrorsResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['PostTransactionsResponsWithErrors'] = ResolversParentTypes['PostTransactionsResponsWithErrors']
> = {
    status?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    batch_issue?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
    batch_check?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PostBankPageResponseResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['PostBankPageResponse'] = ResolversParentTypes['PostBankPageResponse']
> = {
    status?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type BankErrorResolvers<
    ContextType = any,
    ParentType extends ResolversParentTypes['BankError'] = ResolversParentTypes['BankError']
> = {
