...
const RecordType = new graphql_1.GraphQLObjectType({
    name: "Record",
    ...
    fields: () => ({
        ...
        cumulativeBalanceOfOpenSumInRecord: field.cumulativeBalanceOfOpenSumInRecord,
        cumulativeBalanceWithoutOpeningBalance: field.cumulativeBalanceWithoutOpeningBalance,
        ...
        foreignCurrencyCumulativeBalanceWithoutOpeningBalance: field.foreignCurrencyCumulativeBalanceWithoutOpeningBalance,
...
const TransactionType = new graphql_1.GraphQLObjectType({
    ...
    fields: () => ({
        ...
        records: {
            type: graphql_1.GraphQLList(RecordType),
...
const PostTransactionsResponseWithoutErrors = new graphql_1.GraphQLObjectType({
    name: "PostTransactionsResponsWithoutErrors",
    description: "Response for Posting Transactions to a Batch",
    fields: () => (Object.assign(Object.assign({}, PostTransactionsResponseFields), { errors: {
            type: graphql_1.GraphQLString,
            description: "errors list",
        } })),
});
const PostTransactionsResponseWithErrors = new graphql_1.GraphQLObjectType({
    name: "PostTransactionsResponsWithErrors",
    description: "Response for Posting Transactions to a Batch",
    fields: () => (Object.assign(Object.assign({}, PostTransactionsResponseFields), { errors: {
            type: graphql_1.GraphQLList(graphqlType.recordErrorType),
            description: "errors list",
        } })),
});
const PostTransactionsResponseType = new graphql_1.GraphQLUnionType({
...
exports.PostTransactionsResponseType = PostTransactionsResponseType;
const PostTransaction = new graphql_1.GraphQLInputObjectType({
    ...
    fields: () => ({
        ...
        valueDate: field.valueDate,
        records: {
            type: graphql_1.GraphQLList(PostRecord),
            description: "List of Records to add.",
        },
    }),
});
const PostRecord = new graphql_1.GraphQLInputObjectType({
    name: "PostRecord",
...
const postTransactionsToBatchArgs = {
    ...
    transactionsList: {
        type: graphql_1.GraphQLList(PostTransaction),
        description: "List of Transactions to add.",
    },
};
exports.postTransactionsToBatchArgs = postTransactionsToBatchArgs;
//# sourceMappingURL=recordsTransactions.js.map