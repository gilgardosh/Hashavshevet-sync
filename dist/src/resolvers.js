...
const hashavshevet = __importStar(require("./hashavshevet/hashavshevet"));
function allRecords() {
    return (hashavshevet
        .getAllRecords()
        .then((d) => d.repdata)
        ...
        for (const r of recordsListRaw) {
            recordsList.push({
                ...
                foreignCurrencyCumulativeBalanceWithoutOpeningBalance: r.foreign_currency_cumulative_balance_without_opening_balance,
...
function postTransactionsToBatch(args) {
...
exports.postTransactionsToBatch = postTransactionsToBatch;
function allBatches() {
    return (hashavshevet
        .getAllBatches()
        .then((d) => d.repdata)
...
exports.checkBatchById = checkBatchById;
function issueBatch(id) {
    return hashavshevet.checkBatch({ batchNo: id });
}
...
function allBankPageRecords() {
    return (hashavshevet
        ...
        // end of temporary
        .then((bankPageRecordsList) => {
        return bankPageRecordsList;
    }));
}
exports.allBankPageRecords = allBankPageRecords;
function bankPageRecordById(id) {
    return loader.bankPageRecordById.load(id);
}
exports.bankPageRecordById = bankPageRecordById;
function bankPageRecordsByBankPageId(id) {
...
function allBankPages() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const map = new Map();
        for (const bankPage of yield allBankPageRecords()) {
...
exports.allBankPages = allBankPages;
function bankPageById(id) {
    return loader.bankPageById.load(id);
}
exports.bankPageById = bankPageById;
function postBankPage(args) {
    // maping request to hashavshevet key names
...
exports.postBankPage = postBankPage;
function userCompanies() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield hashavshevet.getCompanies().then((data) => {
            return data.repdata;
        });
    });
}
exports.userCompanies = userCompanies;
function userDetails() {
    return __awaiter(this, void 0, void 0, function* () {
        return yield hashavshevet.napi().then((data) => {
            return data.session;
        });
    });
}
